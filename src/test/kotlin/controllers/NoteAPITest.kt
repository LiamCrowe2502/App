...
class NoteAPITest {
    ...
    @BeforeEach
    fun setup(){
        learnKotlin = Note("Learning Kotlin", 5, "College","Notes", false)
        summerHoliday = Note("Summer Holiday to France", 1, "Holiday", "Notes",false)
        codeApp = Note("Code App", 4, "Work","Notes", false)
        testApp = Note("Test App", 4, "Work","Notes", false)
        swim = Note("Swim - Pool", 3, "Hobby","Notes", false)
    ...
    fun `adding a Note to a populated list adds to ArrayList`(){
        val newNote = Note("Study Lambdas", 1, "College", "Notes",false)
    ...
    inner class UpdateNotes {
        ...
        fun `updating a note that does not exist returns false`(){
            assertFalse(populatedNotes!!.updateNote(6, Note("Updating Note", 2, "Work", "Notes",false)))
            assertFalse(populatedNotes!!.updateNote(-1, Note("Updating Note", 2, "Work","Notes", false)))
            assertFalse(emptyNotes!!.updateNote(0, Note("Updating Note", 2, "Work","Notes", false)))
        }
        ...
        fun `updating a note that exists returns true and updates`() {
            ...
            assertTrue(populatedNotes!!.updateNote(4, Note("Updating Note", 2, "College", "Notes",false)))
